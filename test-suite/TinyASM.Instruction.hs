...
main :: IO ()
main = do
  let generatedByteCodeStrings = map (show . toByteCode) instructions
      testResults = [
...
expectedByteCodeStrings = [
              "ByteCode 0x08 0x05 0x00",
              "ByteCode 0x17 0x5a 0x05 0x64",
              "ByteCode 0x21 0x2e",
              "ByteCode 0x08 0x08 0x00",
              "ByteCode 0x09 0x06",
              "ByteCode 0x07 0x02 0x06",
              "ByteCode 0x08 0x03 0x02",
              "ByteCode 0x08 0x01 0x19",
              "ByteCode 0x0f 0x7d",
              "ByteCode 0x07 0x06 0x00",
              "ByteCode 0x09 0x07",
              "ByteCode 0x07 0x02 0x07",
              "ByteCode 0x08 0x03 0x02",
              "ByteCode 0x08 0x01 0x29",
              "ByteCode 0x0f 0x7d",
              "ByteCode 0x07 0x07 0x00",
              "ByteCode 0x07 0x02 0x06",
              "ByteCode 0x07 0x03 0x06",
              "ByteCode 0x08 0x01 0x37",
              "ByteCode 0x0f 0x69",
              "ByteCode 0x07 0x06 0x00",
              "ByteCode 0x07 0x02 0x07",
              "ByteCode 0x07 0x03 0x07",
              "ByteCode 0x08 0x01 0x45",
              "ByteCode 0x0f 0x69",
              "ByteCode 0x07 0x07 0x00",
              "ByteCode 0x0a 0x08 0x06",
              "ByteCode 0x0a 0x08 0x07",
              "ByteCode 0x1f 0x55 0x08 0x90",
              "ByteCode 0x0b 0x09 0x01",
              "ByteCode 0x0b 0x05 0x01",
              "ByteCode 0x0f 0x03",
              "ByteCode 0x21 0x0a",
              "ByteCode 0x22 0x09",
              "ByteCode 0x21 0x2f",
              ...
              "ByteCode 0x0f 0x68",
              "ByteCode 0xff",
              "ByteCode 0x08 0x0a 0x00",
              "ByteCode 0x08 0x00 0x00",
              "ByteCode 0x15 0x7b 0x03 0x0a",
              "ByteCode 0x0b 0x0a 0x01",
              "ByteCode 0x0a 0x00 0x02",
              "ByteCode 0x0f 0x6f",
              "ByteCode 0x0e 0x01",
              "ByteCode 0x08 0x00 0x00",
              "ByteCode 0x19 0x8c 0x02 0x03",
              "ByteCode 0x0b 0x00 0x01",
              "ByteCode 0x0c 0x02 0x03",
              "ByteCode 0x0f 0x80",
              "ByteCode 0x0e 0x01"
              ]
